    ...
    <div class="container">
        <div class="services-layout">
            <div class="services-lhs reveal">
                ...
                <h2>No Installs. No Plug-Ins. No Unnecessary Complexity.</h2>
                ...
                <a href="<?php echo $services_url; ?>" class="btn btn-primary">
                    View all services
                    <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>

            <div class="accordion reveal reveal-d1" id="services-accordion">

                <!-- Identity Verification -->
                <div class="accordion-item active" data-accordion>
                    ...
                    <div class="accordion-body">
                        <div class="accordion-body-inner">
                            ...
                            <a href="<?php echo $services_url; ?>" class="learn-more-link">
                                Learn more
    ...
    <div class="container">
        <div class="security-home-layout">
            <div class="security-home-content reveal">
                ...
                <a href="<?php echo $security_url; ?>" class="btn btn-primary">
                    Security at MCID
                    <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
            ...
            <div class="compliance-badges reveal reveal-d1">
                <a href="<?php echo $security_url; ?>" class="compliance-badge">
