...
<section class="security-hero">
    <div class="container">
        <div class="security-hero-inner reveal">
            <span class="text-label">Security &amp; Privacy</span>
            <h1>Security and compliance are at our core</h1>
            <p>MyCourseID is designed from the ground up to safeguard all user data in accordance with the industry's highest standards of security and privacy.</p>
...
<section class="section" style="padding-top: 0;">
    <div class="container">
        <div class="security-compliance-card reveal">
            ...
            <div class="compliance-badges compliance-badges-lg">
